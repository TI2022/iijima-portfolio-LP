...
export const translations: Translations = {
  ja: {
    ...
    about: {
      ...
      idea: "理念",
      summary2: "スタートアップの皆さんと一緒に課題を見つけ出し、「これだ！」という解決策を形にすることで、会社の成長を後押しするのが私の目標です。",
      background2: "エンジニアとしての技術力はもちろん、「会社の売上を上げるにはどうしたらいいか？」という視点でチームの皆さんと積極的にディスカッションし、技術とビジネス両方の観点から「こんなやり方はどうでしょう？」と提案することを大切にしています。",
      philosophy2: "私がプロジェクトを卒業した後も、「あの時作った仕組みが今も役立ってるよ！」と言ってもらえるような、チーム全体で回していける体制づくりに力を入れています。一緒に働くメンバーが「これなら続けていけそう」と感じられる環境を作ることで、会社の長期的な成長につなげていきたいと思っています。",
    },
    skills: {
      title: "スキル",
      frontend: {
